...
if(cssNumber == 2){
  ...
  $('#camereonThree').attr('src','img1/ヤドカリ4.svg');
  $('#lastgraphShape').attr('src','img1/Left3.svg');
  $('#nextgraphShape').attr('src','img1/Right3.svg');
