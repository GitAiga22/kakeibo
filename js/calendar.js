$(function() {
    ...
    if(cssNumber == 2){
        ...
        $('#noThedayData').attr('src','img1/ヤドカリ2.svg');
        $('#lastmonthShape').attr('src','img1/Left3.svg');
        $('#nextmonthShape').attr('src','img1/Right3.svg');
    ...
    let makeCalender = function() {
        // カレンダータイトルを作る。
        let Cname = "<tr id='calendarTitle'><th colspan='7'>" + myYear + "年" + (myMonth+1) + "月</th></tr>";
    ...
    let makeEitTable = function(Datenum) {
        ...
        for(let i=0; i < eitA.length; i++) {
            ...
            if(thedayArr.length != 0){
                document.getElementById('noThedayData').style.display = 'none';
            }
